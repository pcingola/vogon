...
| `decisions/` | Every `DEC-` |
| `sources/` | Held copies of the documents records cite |
...
write one is in `src/docs/dev/records.md`. The prose standard every record
follows is in `src/docs/dev/writing.md`.
